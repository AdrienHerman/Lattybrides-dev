...
from EXEC_UI import MainWindow
...
# Exécution du logiciel en lignes de commandes
if __name__ == "__main__":
	...
	parser.add_argument("-v", "--version",
                    	...
                    	action="store_true")
	parser.add_argument("-u", "--gui",
						help="Afficher l'interface graphique du logiciel.",
                    	action="store_true")
	...
	# Afficher l'interface graphique du logiciel
	if args.gui:
	...
	# Si aucun argument n'est renseigné afficher l'aide
	if not args.version and not args.gui and not args.custom_configuration and not args.default_configuration:
		print("ERREUR : Aucun argument n'est sélectionné !\n")
		parser.print_help()